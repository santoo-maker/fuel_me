  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Padding(
            padding: EdgeInsets.fromLTRB(1.0, 0.0, 2.0, 84.0),
            child: Stack(
              children: <Widget>[
                Stack(
                  children: <Widget>[
          ...
          Padding(
            padding: EdgeInsets.fromLTRB(26.0, 60.0, 25.0, 76.0),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(size: 218.0, end: 36.0),
                ...
                Align(
                  alignment: Alignment(-0.096, 0.328),
                  child: SizedBox(
                    width: 35.0,
                    height: 50.0,
          ...
          Pinned.fromPins(
            Pin(start: 14.0, end: 13.3),
            Pin(size: 365.0, end: 0.0),
            child: Stack(
              children: <Widget>[
                Padding(
                ...
                Pinned.fromPins(
                  Pin(start: 8.0, end: 23.7),
                  Pin(size: 53.0, start: 0.0),
                  child: Stack(
                    children: <Widget>[
                      Container(),
                      Align(
                        alignment: Alignment(-0.561, 0.04),
                        child: SizedBox(
                          width: 46.0,
                          height: 28.0,
                          child: Text(
                ...
                Pinned.fromPins(
                  Pin(size: 100.0, start: 23.0),
                  Pin(size: 81.0, middle: 0.7148),
                  child: BlendMask(
                ...
                Align(
                  alignment: Alignment(0.612, 0.242),
                  child: Container(
                    width: 35.0,
                    height: 35.0,
                    decoration: BoxDecoration(
                ...
                Pinned.fromPins(
                  Pin(size: 59.0, end: 46.7),
                  Pin(size: 17.0, middle: 0.704),
                  child: Text(
                    'Kerosene',
                    style: TextStyle(
                      fontFamily: 'Avenir',
                ...
                Align(
                  alignment: Alignment(0.633, -0.399),
                  child: SizedBox(
                    width: 51.0,
                    height: 69.0,
                    child: Stack(
                ...
                Pinned.fromPins(
                  Pin(size: 51.0, end: 49.7),
                  Pin(size: 17.0, middle: 0.7529),
                  child: Text(
                    'Rs. 40/ltr',
                    style: TextStyle(
                      fontFamily: 'Avenir',
                ...
                Align(
                  alignment: Alignment(-0.621, 0.237),
                  child: Container(
                    width: 32.0,
                    height: 32.0,
                    decoration: BoxDecoration(
                ...
                Align(
                  alignment: Alignment(-0.603, 0.408),
                  child: SizedBox(
                    width: 25.0,
                    height: 17.0,
                    child: Text(
                ...
                Pinned.fromPins(
                  Pin(size: 53.0, start: 48.0),
                  Pin(size: 69.0, middle: 0.2973),
                  child: PageLink(
                    links: [
                      PageLinkInfo(
                    ...
                    child: Stack(
                      children: <Widget>[
                        ...
                        Align(
                          alignment: Alignment(0.059, 0.019),
                          child: SizedBox(
                            width: 36.0,
                            height: 16.0,
                            child: Text(
                ...
                Align(
                  alignment: Alignment(-0.642, 0.523),
                  child: SizedBox(
                    width: 48.0,
                    height: 17.0,
                    child: Text(
