...
import 'package:proj/Payment.dart';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          //         ),
          //         Pinned.fromPins(
          //           Pin(size: 88.0, end: 6.7),
          //           Pin(size: 52.0, middle: 0.7194),
          //           child: Stack(
          //             children: <Widget>[
          //               Pinned.fromPins(
          ...
          //               ),
          //               Pinned.fromPins(
          //                 Pin(size: 72.9, start: 0.0),
          //                 Pin(size: 31.9, end: 4.0),
          //                 child: Stack(
          //                   children: <Widget>[
          //                     Align(
          ...
          //               ),
          //               Align(
          //                 alignment: Alignment(0.177, -0.071),
          //                 child: SizedBox(
          //                   width: 140.0,
          //                   height: 24.0,
          //                   child: Text(
          ...
          //         ),
          //         Pinned.fromPins(
          //           Pin(start: 52.0, end: 6.1),
          //           Pin(size: 83.3, middle: 0.467),
          //           child: Stack(
          //             children: <Widget>[
          //               Align(
          ...
          //               ),
          //               Pinned.fromPins(
          //                 Pin(size: 25.0, end: 14.4),
          //                 Pin(size: 48.0, end: -0.2),
          ...
          Stack(
            children: <Widget>[
              ...
              Align(
                alignment: const Alignment(-1.0, -0.143),
                child: Container(
                  width: 428.0,
                  height: 285.0,
                  decoration: BoxDecoration(
...
const String _svg_sdq77 =
    '<svg viewBox="61.5 281.5 60.0 1.0" ><path transform="translate(61.5, 281.5)" d="M 0 1 L 60 0" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_ro6i =
    '<svg viewBox="66.5 331.5 55.0 1.0" ><path transform="translate(66.5, 331.5)" d="M 0 0 L 55 0" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_h9ubqk =
    '<svg viewBox="121.5 281.5 1.0 1.0" ><path transform="translate(121.5, 281.5)" d="M 0 0 L 0 1" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_luvahq =
    '<svg viewBox="66.5 380.5 83.0 1.0" ><path transform="translate(66.5, 380.5)" d="M 0 0 L 83 0" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_ab62hf =
    '<svg viewBox="66.5 432.5 88.0 1.0" ><path transform="translate(66.5, 432.5)" d="M 0 1 L 88 0" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
